...
- (void) dealloc
{
    ...
    CCLOG(@"CCUIViewWrapper dealloc in %@", self);
...
{
    //CCLOG(@"setVisible aufgerufen in %@", self);
    
	[super setVisible:v];
	[uiItem setHidden:!v];
    
    //CCLOG(@"CCUIViewWrapper Element visible steht auf: %@", (self.visible ? @"YES" : @"NO"));
    //CCLOG(@"UIItem hidden flag steht auf: %@", (uiItem.hidden ? @"YES" : @"NO"));
